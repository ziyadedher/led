  ...
  return (
    <Headless.Dialog open={open} onClose={close} className="lg:hidden">
      ...
      <Headless.DialogPanel
        transition
        className="max-w-80 fixed inset-y-0 w-full p-2 transition duration-300 ease-in-out data-closed:-translate-x-full"
      >
...
export function SidebarLayout({
  ...
  return (
    <div className="min-h-svh relative isolate flex w-full bg-white dark:bg-zinc-900 max-lg:flex-col lg:bg-zinc-100 dark:lg:bg-zinc-950">
      {/* Sidebar on desktop */}
